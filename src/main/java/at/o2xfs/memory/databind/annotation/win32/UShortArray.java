...
import at.o2xfs.memory.databind.ser.win32.UShortArraySerializer;

@Retention(RetentionPolicy.RUNTIME)
@MemoryAnnotationsInside
@MemorySerialize(using = UShortArraySerializer.class)
@MemoryDeserialize(using = UShortArrayDeserializer.class)
public @interface UShortArray {
